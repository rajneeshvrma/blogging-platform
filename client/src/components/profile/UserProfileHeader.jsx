            ...
            <div className="p-6 relative">
                <div className="flex justify-between items-start">
                    ...
                    {isOwnProfile ? (
                        ...
                        <button onClick={() => onFollow(profile._id)} className={`py-2 px-6 rounded-full font-semibold transition-colors ${isFollowing ? 'bg-white/20 dark:bg-black/20 text-text-primary' : 'bg-indigo-500 text-white hover:bg-indigo-600'}`}>
