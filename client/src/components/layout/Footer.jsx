    ...
    <footer className="mt-20 text-text-secondary px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto py-12 px-8 bg-glass backdrop-blur-lg rounded-xl border border-glass">
            ...
            <div className="mt-12 border-t border-glass pt-8 flex flex-col sm:flex-row justify-between items-center">
                ...
                <div className="text-sm text-text-secondary mt-4 sm:mt-0">Designed by <span className="relative group text-text-primary font-semibold cursor-pointer hover:text-red-500"><a href='https://www.linkedin.com/in/rajneeshvrma/'>RAJNEESH </a>
                    <div className="absolute bottom-full mb-2 w-64 bg-transparent border border-transparent rounded-lg p-1 text-left opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none group-hover:pointer-events-auto -translate-x-1/2 left-1/2 z-10">
                        <div className="flex items-center">
                            <img
                                src="https://media.licdn.com/dms/image/v2/D5603AQGAFqDci5xVWA/profile-displayphoto-scale_200_200/B56Zoa9etXJQAc-/0/1761388917222?e=1763596800&v=beta&t=Vh19WUEvY-UWxnJOs-7WgwPXTMIlNcg8YzVb-1nZdR4"
                                alt="Raj"
